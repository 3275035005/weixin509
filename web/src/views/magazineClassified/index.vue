  ...
  <div class="app-container">
    <el-form :inline="true" class="demo-form-inline">
      <el-form-item label="分类名称">
        <el-input v-model="dataVo.title" placeholder="请输入外刊分类名称"/>
      </el-form-item>
    ...
    >
      ...
      <el-table-column prop="title" label="外刊分类名称"/>
      <el-table-column prop="content" label="外刊分类介绍"/>
    ...
    >
      ...
      <el-form :model="formData" label-position="left" label-width="120px">
        <el-form-item label="外刊分类名称">
          <el-input v-model="formData.title" placeholder="请填写外刊分类名称"/>
        </el-form-item>
        <el-form-item label="外刊分类介绍">
          <el-input
            type="textarea"
            :rows="2"
            v-model="formData.content"
            placeholder="请填写外刊分类介绍" />
        </el-form-item>
      </el-form>
...
<script>
import {deleteById, insert, update, pageQuery} from '@/api/magazineClassified'
