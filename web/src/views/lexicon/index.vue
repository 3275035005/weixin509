  ...
  <div class="app-container">
    <el-form :inline="true" class="demo-form-inline">
      <el-form-item label="词库名称">
        <el-input v-model="dataVo.title" placeholder="请输入词库名称"/>
      </el-form-item>
    ...
    >
      ...
      <el-table-column prop="id" label="词库ID"/>
      <el-table-column prop="title" label="词库名称"/>
      <el-table-column prop="createTime" label="创建时间"/>
      <el-table-column label="操作" align="center">
        <template slot-scope="scope">
          <el-button type="primary" size="mini" icon="el-icon-search" @click="lexiconInfosBtn(scope.row.lexiconInfos)">查看词库</el-button>
    ...
    >
      ...
      <el-form :model="formData" label-position="left" label-width="120px">
        <el-form-item label="词库名称">
          <el-input v-model="formData.title" placeholder="请填写词库名称"/>
        </el-form-item>
      </el-form>
...
<script>
import { deleteById, insert, update, pageQuery} from '@/api/lexicon'
export default {
  data() { // 定义变量和初始值
    return {
      list: [], // 查询之后接口返回集合
